...
const DEFAULT_TARGETS = [
  ...
  ".ai-runs/mailhub-next-phase/mailhub-routing-secrets-plan.json",
  ".ai-runs/mailhub-next-phase/mailhub-staff-github-config-plan.json",
  ...
  ".ai-runs/mailhub-next-phase/mailhub-staff-env-readiness.json",
  ...
  ".ai-runs/mailhub-next-phase/mailhub-production-config-request.json",
  ".ai-runs/mailhub-next-phase/mailhub-production-config-intake.md",
